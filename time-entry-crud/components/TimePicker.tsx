...
/**
 * Material-style 24-hour analog clock picker. Outer ring is 12+1-11
 * (AM-equivalent), inner ring is 00 + 13-23 (PM 24h labels). Two-step:
 * pick hour → switches to minute ring → OK to commit. Includes a text
 * input fallback toggled by the keyboard icon.
 */
          ...
          <div className="bg-[#1c1b1f] rounded-3xl overflow-hidden w-full max-w-[320px] shadow-2xl">
            <div className="bg-[#2c2b2f] px-8 pt-6 pb-4">
              ...
              <div className="flex items-center justify-center gap-1">
                ...
                <span className="text-6xl font-light text-gray-300 select-none">
                  :
                </span>
                <button
                  type="button"
